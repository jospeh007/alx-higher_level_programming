...
/**
 * print_python_float - print the float info about the python
 * @p: python object structure
 */
...
/**
 * print_python_bytes - print the bytes info about the python
 * @p: python object structure
 */
void print_python_bytes(PyObject *p)
{
	...
	for (i = 0; i < len; i++)
		printf("%2hhx%s", str[i], i + 1 < len ? " " : "");
	printf("\n");
}

/**
 * print_python_list - print the list info about the python
 * @p: python object structure
 */
void print_python_list(PyObject *p)
{
	...
	for (i = 0; i < ((PyVarObject *)p)->ob_size; i++)
	{
		...
		{
			if (((PyListObject *)p)->ob_item[i] != NULL)
